...
@Component
@RabbitListener(queues = {RabbitMQConstants.QUEUE_NINE}, containerFactory = "simpleManualRabbitListenerContainerFactory")
public class RabbitMQManualAckConsumer extends RabbitMQBaseConsumer {
